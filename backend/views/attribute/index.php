...
<div class="table-layout">
    <div class="tray tray-center">
        ...
        <div class="row">
            <div id="attribute-form_cont" class="col-lg-2 col-sm-3">
                <?= Html::a('<span class="fa fa-plus pr5"></span> ' . Yii::t('app', 'Create Filter'), ['/attribute/create'], ['class' => 'btn btn-system mb15']) ?>
            </div>
        </div>
        <!-- recent orders table -->
        <div class="panel">
            <div class="panel-body pn">
                <div class="table table-responsive">
                    <?= GridView::widget([
                        ...
                        'summary' => true,
                        'options' => ['class' => 'br-r', 'id' => 'attribute'],
                        'columns' => [
                            ['attribute' => 'image',
                                'format' => 'html',
