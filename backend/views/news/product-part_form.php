<?php if (!empty($data)): ?>
    <?php foreach ($data as $key => $value): ?>
        ...
        <div class="<?php echo $cont_class ?> ar_" id="<?php echo $cont_id; ?>">
            ...
            <input type="hidden" id="newsparts-<?php echo $key; ?>-id" name="newsParts[<?php echo $key; ?>][id]" value="<?php echo $value['id'] ?>">
            <div class="section row mbn">
                <div class="col-md-6 pt15">
                    <div class="form-group field-newsparts-<?php echo $key; ?>-name required">
                        <div class="col-md-12" style="padding: 0"><label for="customer-name" class="field prepend-icon">
                                <input type="text" id="newsparts-<?php echo $key; ?>-name" class="form-control"
                                       name="newsParts[<?php echo $key; ?>][name]" placeholder="Part Name"
                ...
                <div class="col-md-6 pt15">
                    <div class="form-group field-newsparts-<?php echo $key; ?>-price">
                        <div class="col-md-12" style="padding: 0"><label for="customer-name" class="field prepend-icon">
                                <input type="text" id="newsparts-<?php echo $key; ?>-price" class="form-control"
                                       name="newsParts[<?php echo $key; ?>][price]" placeholder="Part Price"
            ...
            <div class="section row mbn">
                <div class="col-md-4 pt15">
                    <div class="form-group field-newsparts-<?php echo $key; ?>-status">
                        <div class="col-md-12" style="padding: 0">
                            <label for="customer-name" class="field prepend-icon">
                                <input type="text" id="newsparts-<?php echo $key; ?>0-in_stock" class="form-control"
                                       name="newsParts[<?php echo $key; ?>][in_stock]" placeholder="Amount in ctock"
                ...
                <div class="col-md-8 pt15">
                    <div class="form-group field-newsparts-<?php echo $key; ?>-description required">
                        <div class="col-md-12" style="padding: 0">
                            <label for="customer-name" class="field prepend-icon">
                            <textarea id="newsparts-<?php echo $key; ?>-description" class="form-control"
                                      name="newsParts[<?php echo $key; ?>][description]"
            ...
            <div class="section row mbn">
                <div class="col-md-6 pt15 imgf">
                    <div class="form-group field-newsparts-<?php echo $key; ?>-parts_imagefiles">
                        <div>
                            <div class="box">
                                <input type="hidden" name="newsParts[<?php echo $key; ?>][parts_imageFiles][]"
                                       value="">
                                <input type="file" id="newsparts-<?php echo $key; ?>-parts_imagefiles" class="inputfile inputfile-6"
                                       name="newsParts[<?php echo $key; ?>][parts_imageFiles][]" multiple="" accept="image/*"
                                       onchange="showMyImage(this, <?php echo $key; ?>)"
                                       data-multiple-caption="{count} files selected">
                                <label class="" for="newsparts-<?php echo $key; ?>-parts_imagefiles">
                                    <span></span>
                ...
                <?php $PartImages = \backend\models\newsParts::getImageByPartId($value['id']) ?>
