...
/* @var $news_attribute_model backend\models\newsAttribute */
            ...
            <div class="tab-content pn br-n admin-form">
                ...
                <div class="col-md-3">
                    <?=
                            ...
                            ->textInput(['maxlength' => true, 'placeholder' => 'news Name'])->label(false)
                    ?>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <?=
                            $form->field($model, 'news_sku', ['template' => '<div class="col-md-12" style="padding: 0"><label for="customer-name" class="field prepend-icon">
                                    {input}<label for="customer-name" class="field-icon"><i class="fa fa-barcode"></i></label></label>{error}</div>'])
                            ->textInput(['maxlength' => true, 'placeholder' => 'news SKU'])->label(false)
                    ?>
                </div>
                ...
                <div class="col-md-3">
                    <?=
                            ...
                            ->textInput(['placeholder' => 'news Price'])->label(false)
                    ?>
                </div>
                <div class="col-md-3">
<?=
        ...
        ->textInput(['placeholder' => Yii::t('app', 'news Weight')])->label(false)
?>
                </div>
                <!-- end section -->
            ...
            <div class="section row ">
                <div class="col-md-4">
                    <?=
                            $form->field($model, 'news_count', ['template' => '<div class="col-md-12" style="padding: 0"><label for="customer-name" class="field prepend-icon">
                                    {input}<label for="customer-name" class="field-icon"><i class="fa fa-euro"></i></label></label>{error}</div>'])
                            ->textInput(['placeholder' => Yii::t('app', 'news Count')])->label(false)
                    ?>
                    ...
                    <div class="col-md-4">
                        <div class="option-group field">
                            ...
                            <div class="form-group">
                                <input type="text" name="newsAttribute[value][<?php echo $attribute['attribute_id'] ?>]" value="<?php echo $attribute['value'] ?>" class="form-control" id="attribute_value_<?php echo $attribute['id'] ?>" placeholder="Attribute Value">
                            </div>
                        </div>
                    </div>
<?php endforeach; ?>
...
?>
<?php echo Html::a(Yii::t('app', 'Reset'), Url::to('/' . Yii::$app->language . '/news/index', true), ['class' => 'btn btn-default btn-sm ph25 reste-button-news']); ?>
        </div>
    </div>
