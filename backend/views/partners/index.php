...
/** @var backend\models\PartnersSearch $searchModel */
...
<div class="table-layout">
    <div class="tray tray-center">
        ...
        <div class="row">
            <div id="partners-form_cont" class="col-lg-2 col-sm-3">
                <?= Html::a('<span class="fa fa-plus pr5"></span> ' . Yii::t('app', 'Create Partners'), ['/partners/create'], ['class' => 'btn btn-system mb15']) ?>
            </div>
        </div>
            ...
            <div class="panel-body pn">
                <div class="table table-responsive">
                    <?= GridView::widget([
                        ...
                        'summary' => true,
                        'options' => ['class' => 'br-r', 'id' => 'partners'],
                        'columns' => [
                            'id',
                            'title',
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    if (!empty($model->path)) {
                                        return Html::img('/' . ltrim($model->path, '/'), ['style' => 'width: 40px !important']);
                                    }
                                    return '';
                                },
                            ],
