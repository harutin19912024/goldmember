...
$this->title = Yii::t('app', 'Power Of Pennies');
...
<div class="table-layout">
    <div class="tray tray-center">
        ...
        <div class="row">
            <div id="power-of-penny-form_cont" class="col-lg-2 col-sm-3">
                <?= Html::a('<span class="fa fa-plus pr5"></span> ' . Yii::t('app', 'Create Power Of Penny'), ['/power-of-penny/create'], ['class' => 'btn btn-system mb15']) ?>
            </div>
        </div>
        <!-- recent orders table -->
        <div class="panel">
            <div class="panel-body pn">
                <div class="table table-responsive">
                    <?= GridView::widget([
                        ...
                        'summary' => true,
                        'options' => ['class' => 'br-r', 'id' => 'power-of-penny'],
                        'columns' => [
                            'id',
                            'content:ntext',
                            'video_url:url',
